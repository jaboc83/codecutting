          ...
          >
            ...
            <div className="flex">
              <a
                ...
                className="bg-blue-600 hover:bg-blue-400 focus:bg-blue-400 text-blue-200 text-sm rounded border-none shadow-lg px-4 py-2 my-2"
              >
              ...
              <a
                ...
                className="bg-blue-600 hover:bg-blue-400 focus:bg-blue-400 text-blue-200 text-sm rounded border-none shadow-lg px-4 py-2 my-2 ml-2"
              >
